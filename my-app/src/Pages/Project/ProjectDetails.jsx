            ...
            <div className="project_name_box">
              ...
              <div className="project_shot_info">
                ...
                <div className="project_button_arrows">
                  <div className="project_button_one">
                    <Link
                      to={routeMap.project_details.replace(':slug', currentProject.button_last)}
                      className="project_button prev"
                    >
                    <svg className="project_arrows_svg prev" version="1.1" x="0px" y="0px" viewBox="0 0 284.935 284.936" xmlSpace="preserve">
                      <g>
                  ...
                  <div className="project_button_one">
                    ...
                    >next
                    <svg className="project_arrows_svg next" version="1.1" x="0px" y="0px" viewBox="0 0 284.935 284.936" xmlSpace="preserve">
                      <g>
