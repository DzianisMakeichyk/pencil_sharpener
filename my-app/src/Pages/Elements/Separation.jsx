  ...
  render(){
    return (
        <div className="separation">
          <div className="seporator_circul_one">
            <div className="seporator_circul_two"></div>
          </div>
          <svg className="separation_arrow" x="0px" y="0px" viewBox="0 0 284.9 284.9" xmlSpace="preserve">
            <g>
